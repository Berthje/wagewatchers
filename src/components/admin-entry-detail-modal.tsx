            ...
            <Card className="bg-stone-800 border-stone-700">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <InfoItem
                    label="Age"
                    value={entry.age !== null ? `${entry.age} years` : undefined}
                  />
                  <InfoItem label="Education" value={entry.education} />
                  <InfoItem
                    label="Work Experience"
                    value={
                      entry.workExperience !== null ? `${entry.workExperience} years` : undefined
                    }
                  />
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <InfoItem
                    ...
                    value={
                      entry.officialHours !== null ? `${entry.officialHours} hours/week` : undefined
                    }
                  />
                  <InfoItem
                    label="Average Hours"
                    value={
                      entry.averageHours !== null ? `${entry.averageHours} hours/week` : undefined
                    }
                  />
                  <InfoItem
                    label="Vacation Days"
                  ...
                  <InfoItem
                    label="Telework Days"
                    value={
                      entry.teleworkDays !== null ? `${entry.teleworkDays} days/week` : undefined
                    }
                  />
              ...
              <Card className="bg-stone-800 border-stone-700">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    {entry.anomalyReason && <InfoItem label="Reason" value={entry.anomalyReason} />}
                  </div>
                </CardContent>
              </Card>
            )}
