  ...
  if (loading) {
    return (
      <Card className="bg-stone-800 border-stone-700 space-y-3">
        <CardHeader>
          <CardTitle className="text-stone-100">{t("charts.ageDemographics.title")}</CardTitle>
            ...
            <div className="relative">
              ...
              <div className="w-48 h-48 rounded-full bg-stone-700 animate-pulse relative">
                ...
                <div className="absolute inset-2 rounded-full bg-stone-800">
                  <div
                    className="absolute top-2 left-2 w-8 h-8 bg-stone-600 rounded-full animate-pulse"
                    style={{ animationDelay: "0.1s" }}
                  ></div>
                  <div
                    className="absolute top-8 right-4 w-6 h-6 bg-stone-500 rounded-full animate-pulse"
                    style={{ animationDelay: "0.2s" }}
                  ></div>
                  <div
                    className="absolute bottom-6 left-6 w-10 h-10 bg-stone-600 rounded-full animate-pulse"
                    style={{ animationDelay: "0.3s" }}
                  ></div>
                  <div
                    className="absolute bottom-4 right-8 w-7 h-7 bg-stone-500 rounded-full animate-pulse"
