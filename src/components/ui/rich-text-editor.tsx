    ...
    <div className="border border-stone-600 rounded-md overflow-hidden">
      ...
      <div className="flex flex-wrap gap-1 p-2 border-b border-stone-600 bg-stone-800">
        <Button
          ...
          className={editor.isActive("bold") ? "bg-stone-700" : ""}
        >
        ...
        <Button
          ...
          className={editor.isActive("italic") ? "bg-stone-700" : ""}
        >
        ...
        <Button
          ...
          className={editor.isActive("heading", { level: 2 }) ? "bg-stone-700" : ""}
        >
        ...
        <Button
          ...
          className={editor.isActive("bulletList") ? "bg-stone-700" : ""}
        >
        ...
        <Button
          ...
          className={editor.isActive("orderedList") ? "bg-stone-700" : ""}
        >
        ...
        <Button
          ...
          className={editor.isActive("blockquote") ? "bg-stone-700" : ""}
        >
