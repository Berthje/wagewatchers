...
export default function NotFound() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-950 via-slate-950 to-slate-900">
            <div className="text-center px-6 py-12 md:px-8 md:py-16 max-w-2xl mx-auto">
                ...
                <p className="text-gray-300 mb-8 md:mb-12 text-lg md:text-xl leading-relaxed max-w-lg mx-auto">
                    Looks like this page took a salary cut and disappeared. But don&apos;t worry, your wage data is safe with us!
                </p>
                <div className="space-y-4">
                    <Link
                        href="/en"
                        className="inline-flex items-center px-6 py-2 md:px-8 md:py-3 border border-transparent text-lg md:text-xl font-semibold rounded-md text-white bg-slate-600 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105"
                    >
                        Go back home
                    </Link>
