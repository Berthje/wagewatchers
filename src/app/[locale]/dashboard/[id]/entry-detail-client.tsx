                ...
                <Card className="mb-6 bg-stone-800 border-stone-700">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <InfoItem
                                label={t("dependents")}
                                value={entry.dependents?.toString()}
                            />
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="mb-6 bg-stone-800 border-stone-700">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            />
                            <InfoItem
                                label={t("shiftDescription")}
                                value={entry.shiftDescription}
                            />
                            <InfoItem
                                label={t("onCall")}
                                value={entry.onCall}
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {shouldShow("groupInsurance") && (
                                <InfoItem
                                    label={t("groupInsurance")}
                                    value={entry.groupInsurance}
                                />
                            )}
                            {shouldShow("otherInsurances") && (
                                <InfoItem
                                    label={t("otherInsurances")}
                                    value={entry.otherInsurances}
                                />
                            )}
                        </div>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <InfoItem
                                ...
                                value={entry.commuteMethod}
                            />
                            <InfoItem
                                label={t("commuteCompensation")}
                                value={entry.commuteCompensation}
                            />
                        </div>
                    </CardContent>
                </Card>
