    ...
    <div className="min-h-screen bg-linear-to-br from-stone-950 to-stone-900">
      ...
      <div className="container mx-auto p-6">
        <div className="mb-6">
          ...
          {/* Filters */}
          <div className="mb-6 space-x-6 flex w-full">
            {/* Search Bar */}
          ...
          <DragOverlay>
            {activeReport ? (
              <Card className="cursor-grabbing shadow-2xl border-stone-700 bg-stone-900 rotate-3">
                ...
                <CardContent>
                  <p className="text-sm text-stone-400 line-clamp-3">{activeReport.description}</p>
                </CardContent>
              </Card>
            ) : null}
          </DragOverlay>
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-stone-100">{selectedReport.title}</h3>
              ...
              <div>
                ...
                <div className="mt-2 p-4 bg-stone-800/50 rounded-lg border border-stone-700">
                  <p className="text-stone-100 whitespace-pre-wrap">{selectedReport.description}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1 text-stone-100 font-mono text-sm bg-yellow-900/20 px-2 py-1 rounded border border-yellow-800">
