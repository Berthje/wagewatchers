...
export default function StatusClient() {
    ...
    const [searchType, setSearchType] = useState<"trackingId" | "email">(
        "trackingId"
    );
    ...
    const getResultsTitle = (reports: Report[], myTrackingIds: string[], searched: boolean): string => {
