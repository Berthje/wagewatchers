...
import { Edit, Eye, Trash2, AlertCircle, Calendar, HelpCircle, AlertTriangle } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
function MyEntriesContent() {
  ...
  const [entryToDelete, setEntryToDelete] = useState<SalaryEntry | null>(null);
            ...
            <div className="space-y-5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-stone-400">
                    {entryToDelete.country
                      ...
                      : "-"}{" "}
                    • {formatSalary(entryToDelete.grossSalary)}
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button
                  ...
                  disabled={deleteConfirmText !== "DELETE" || deletingId !== null}
                  className="flex-1"
                >
                  {deletingId !== null ? (
                    <span className="ml-2">{t("deleteDialog.deleting")}</span>
                  ) : (
                    <>
