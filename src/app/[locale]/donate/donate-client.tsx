      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-block mb-4 animate-bounce">
            <Coffee className="h-20 w-20 text-orange-500" strokeWidth={1.5} />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-stone-100 mb-4">{t("title")}</h1>
          <p className="text-xl text-stone-400 mb-2">{t("subtitle")}</p>
        </div>

        {/* Main Description */}
        <Card className="mb-8 border-2 border-orange-900/50 shadow-lg">
          <CardContent>
            <p className="text-lg text-stone-300 leading-relaxed">{t("description")}</p>
          </CardContent>
        </Card>
        ...
        <div className="mb-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-stone-100 mb-3">{t("thankYou")}</h3>
            <p className="text-stone-300 max-w-2xl mx-auto">{t("thankYouMessage")}</p>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
              ...
              >
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-bold text-lg text-stone-100 mb-1">{t("buyMeCoffee")}</div>
                    <div className="text-sm text-stone-400">{t("oneTimeSupport")}</div>
                  </div>
              ...
              >
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-bold text-lg text-stone-100 mb-1">{t("paypal")}</div>
                    <div className="text-sm text-stone-400">{t("securePayment")}</div>
                  </div>
              ...
              >
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-bold text-lg text-stone-100 mb-1">{t("kofi")}</div>
                    <div className="text-sm text-stone-400">{t("supportWithKofi")}</div>
                  </div>
              ...
              >
                <div className="relative z-10 flex items-center gap-4">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-bold text-lg text-stone-100 mb-1">{t("github")}</div>
                    <div className="text-sm text-stone-400">{t("monthlySponsorship")}</div>
                  </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-lg text-stone-100 mb-1">{t("ethereum")}</div>
                      <div className="text-sm text-stone-400 break-all">
                        0xA7D90734fB2B0aa3769DbCa79d496ec1939cd272
                      </div>
                      <div className="text-xs text-stone-500 mt-1">{t("ethereumNote")}</div>
                    </div>
                  </div>
                  <button
              ...
              <div className="group relative overflow-hidden rounded-xl border-2 border-orange-900/50 bg-linear-to-br from-orange-950/30 to-yellow-950/30 p-6 transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:border-orange-600">
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-lg text-stone-100 mb-1">{t("bitcoin")}</div>
                      <div className="text-sm text-stone-400 break-all">
              ...
              <div className="group relative overflow-hidden rounded-xl border-2 border-purple-900/50 bg-linear-to-br from-purple-950/30 to-violet-950/30 p-6 transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:border-purple-600">
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-lg text-stone-100 mb-1">{t("solana")}</div>
                      <div className="text-sm text-stone-400 break-all">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-stone-100 mb-6">{t("otherWays")}</h2>
        ...
        <footer className="mt-16 md:mt-24 text-center px-4">
          <p className="text-stone-500 text-sm mb-2">{t("footerCommunity")}</p>
