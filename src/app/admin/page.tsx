...
import { ClipboardCheck, LayoutDashboard, ArrowRight, ShieldCheck } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-12 mt-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white bg-clip-text">Admin Dashboard</h1>
              <p className="text-muted-foreground mt-1">Manage and monitor WageWatchers platform</p>
            </div>
          </div>
        </div>
